...
/*
 * Web Browser ----url req ----> 
 * 						tomcat --- context --- Filter.dofFilter(
 * 										   --- Controller.doGet 또는 
 * 											   Controller.doPost()
 * 
...
/*
 * Filter에서 response.setContentType()을 지정할때 text/html로 지정을 하면
 * 	jsp,js, 기타 여러가지 static 파일들이 모두 html ContetType으로 지정되어
 * 	WebBrowser로 전송되어 제기능을 수행하지 못하는 현상이 발생한다
 * 
 *  이럴때 WebFilter urlPatterns를 문자열 배열로 생성하고,
