...
public class TodoServiceImplV1 implements TodoService{
	 ...
	 * 메타데이터
	 * 	객체,Entity, Replation
	 *  DateBase를 만들고, Table을 생성한 후
	 *  Insert를 수행하면 실제상황의 데이터가 Table에 저장된다
	 *  Insert를 수행한후 select를 수행하여 조회를 할 수 있는 데이터들
	 *  
	 *  메타데이터(meta data)
	 *   생성한 Database, table, sequence, view...이 
	 *   어떤 구조로 만들어져 있는가 등의 정보를 메타 데이터라고 한다
	 *   예) myDB라는 database에 몇개의 table이 있는가 등의
	 *   		정보를 알고 싶으면 myDB 메타데이터를 참조하면 된다
	 */
