 ...
 *  	값을 put(), get() 할때 key값을 ""로 감싼 문자열 형식으로
 *  	사용해야 하기 때문에 많은 오타로 인한 논리적 오류가 발생할수 있다
 *  이러한 문제를 방지하기 위해 
 *  	key 값을 별도의 static 변수로 만들어두고, 
 *  	활용하는 방법을 사용한다
 *  
 */
public interface TodoService {
	 ...
	 * 		strmap.put("이름", "홍길동") --> 데이터는 문자열 type만 저장가능
	 * 
	 * 		Map<String, Integer> intMap
	 * 		intMap.put("이름, 100) --> 데이터는 정수형 type만 저장가능
	 * 
	 * 		Map<String, Object> objMap
	 * 		objMap.put("이름", "홍길동");
	 * 		objMap.put("나이", 33); -- > 어떤 type의 데이터라도 저장가능
	 * 
	 * 
	 */
