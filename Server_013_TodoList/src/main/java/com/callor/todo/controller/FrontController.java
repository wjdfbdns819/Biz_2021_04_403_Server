...
import com.callor.todo.commmand.HomeCommandImplV1;
import com.callor.todo.commmand.TodoCommandImplV1;
import com.callor.todo.commmand.TodoCommand;
 ...
 *  POJO
 *  (Plan Old Java Object, 어떤 클래스를 상속받지 않은 일반적인 
 *   자바 클래스 형식의 코드)를 사용하여 프로젝트를 진행하도록 하는 것
...
public class FrontController extends HttpServlet{
	...
	//	한번 실행되어서 여러가지 변수 등을 초기화하는 코드
	@Override
	public void init(ServletConfig config) throws ServletException {
		commands = new HashMap<String, TodoCommand>();
		
		// "/" 라고 요청을 하면 HomeCommmandImplV1한테 넘기고 대신 실행하게 함
		/*
		 ...
		 * 	TodoCommandImpV1 객체를 사용하여 요청을 처리하기 위한 준비
		 */
