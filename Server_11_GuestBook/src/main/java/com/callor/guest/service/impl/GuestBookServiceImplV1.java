...
import com.callor.guest.service.GuestBookSerivce;

public class GuestBookServiceImplV1 implements GuestBookSerivce{
	...
	@Override
	public List<GuestBookVO> findByWriter(String gb_wirter) {
